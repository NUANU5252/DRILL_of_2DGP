...
RUN_SPEED_KMPH = 180.0  # Km / Hour   검색 결과 시속 180km/h라고 한다.. ?
...
class Bird:
    ...
    def __init__(self):
        ...
        self.y = random.randint(50, 1600-50)
    ...
    def draw(self):
        if dir == 0:
            ...
            self.image.clip_composite_draw(int(self.frame) * 100, 100, 100, 100, 0, 'v', self.x, self.y)
        else:
            self.image.clip_draw(int(self.frame) * 100, 100, 100, 100, self.x, self.y)
        # fill here for draw
